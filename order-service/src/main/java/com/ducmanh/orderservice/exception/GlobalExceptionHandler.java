...
import com.ducmanh.catalogservice.exception.AppException;
import com.ducmanh.catalogservice.exception.ErrorCode;
...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiResponse> handlingException(Exception exception){
        // QUAN TRỌNG: Phải ghi log lại lỗi này để debug
        log.error("Lỗi hệ thống chưa được xử lý: ", exception);
